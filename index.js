...
const pkey = '03d0fbc7d8633d1021aa2af3c0f2a5220e9fc2ef2185b2444f15d2cc7b30338a' // token holder pkey

const contractAddress = '0x2Be80F66a0fb370A5f45c24a906bfc60a8501C6b' // token contract address
    ...
    if (bData.length === 0) {
      ...
      if (joinCheck) {
        ...
        if (('inviter' in pData[0]) && !('referred' in dbData[0])) {
          ...
          var see = cal + sen
          var bot_cur = 'tom'
          bot.telegram.sendMessage(pData[0].inviter, '➕ New Referral on your link you received 10000 DKN', { parse_mode: 'markdown' })
...
let joinCheck = await findUser(ctx)
  if(joinCheck){
    ...
    await ctx.replyWithMarkdown(`🔹Follow *`+airdropName+`* on [Twitter](https://twitter.com/airdropoption), Like and Retweet pinned post 
